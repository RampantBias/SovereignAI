...
- **AUTHOR NOTE:** Define the first adversary model and regulated-environment assumptions for the public architecture.
- **AUTHOR NOTE:** Define whether arbitrary custom agent images are admitted directly or must pass an organizational build/signing pipeline.
